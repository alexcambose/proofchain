...
interface ICertificatesTableMaterialsProps {
  certificates: ICertificate[];
  isLoading?: boolean;
}
const CertificatesTableMaterials: React.FC<ICertificatesTableMaterialsProps> = ({
  isLoading,
  certificates,
}) => {
  return (
...
export default CertificatesTableMaterials;
