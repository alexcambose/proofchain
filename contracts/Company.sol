...
contract Company is Certifiable {
    ...
    function assignCertificate(uint256 _certificateCode, address _company)
        public
        payable
    {
        ...
        public
    {
        ...
        for (i = 0; i < length; i++) {
            if (companies[_company].certificates[i].code == _certificateCode) {
                companies[_company].certificates[i] = companies[_company]
    ...
    {
        return
            companies[_company].certificates[
                companies[_company].certificates.length - 1
            ];
    }
